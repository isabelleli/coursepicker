...
public class CourseInformationTest{
  ...
  public CourseInformationTest(){
    ...
    courseDetails.put("10006", new String[] {"TF", "11:00AM", "ENI", "01", "09:50AM", "CS 111"});
    courseDetails.put("10042", new String[] {"MTHF", "12:20AM", "LYN", "02", "11:00AM", "CS 111"});
    courseDetails.put("12822", new String[] {"MWTH", "01:30PM", "SOHIE", "03", "02:40PM", "CS 111"});
    }
